...
export default async function EventsPage() {
  // Fetch events at build time and on revalidation
  // For ISR, we fetch data on the server
  const events = getAllEvents()

  return (
    <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 sm:text-4xl">All Events</h1>
